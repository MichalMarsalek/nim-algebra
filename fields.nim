...
template one*[DEG, MOD, V](R:typedesc[BinaryField[DEG, MOD, V]]):R = 1'u64
template gen*[DEG, MOD, V](R:typedesc[BinaryField[DEG, MOD, V]]):R = 2'u64
func `+`[DEG,MOD](a,b:BinaryField[DEG,MOD]):BinaryField[DEG,MOD] {.inline.} =
    BinaryField[DEG,MOD] (a.uint64 xor b.uint64)
func `+=`[DEG,MOD](a:var BinaryField[DEG,MOD],b:BinaryField[DEG,MOD]) {.inline.} =
    a = a + b
func `-`[DEG,MOD](a,b:BinaryField[DEG,MOD]):BinaryField[DEG,MOD] {.inline.} =
    a + b
func `-=`[DEG,MOD](a:var BinaryField[DEG,MOD],b:BinaryField[DEG,MOD]) {.inline.} =
    a = a - b
func `-`[DEG,MOD](a:  BinaryField[DEG,MOD]):BinaryField[DEG,MOD] {.inline.} =
    a
func `*`[DEG,MOD](a,b:BinaryField[DEG,MOD]):BinaryField[DEG,MOD] =
...
include algos
func `^`[DEG,MOD](a:BinaryField[DEG,MOD],exp:int):BinaryField[DEG,MOD] =
...
#GENERAL FIELD
template zero*(R:typedesc[BinaryField]):R = discard
template one*(R:typedesc[BinaryField]):R = result.coeffs[0] = 1
template gen*(R:typedesc[BinaryField]):R = result.coeffs[1] = 1
discard """
func `+=`[P,DEG,MOD](a:var GenFiniteField[P,DEG,MOD],b:GenFiniteField[P,DEG,MOD]) {.inline.} =
    for i in 0..<DEG:
        a.coeffs[i] = (a.coeffs[i] + b.coeffs[i]) mod P
        
func `+`[P,DEG,MOD](a,b:GenFiniteField[P,DEG,MOD]):GenFiniteField[P,DEG,MOD] {.inline.} =
    result = a
    result += b
func `-=`[P,DEG,MOD](a:var GenFiniteField[P,DEG,MOD],b:GenFiniteField[P,DEG,MOD]) {.inline.} =
    for i in 0..<DEG:
...
func `-`[P,DEG,MOD](a,b:GenFiniteField[P,DEG,MOD]):GenFiniteField[P,DEG,MOD] {.inline.} =
    result = a
    result += b
func `-`[P,DEG,MOD](a:  GenFiniteField[P,DEG,MOD]):GenFiniteField[P,DEG,MOD] {.inline.} =
    for i in 0..<DEG:
        result.coeffs[i] = (P - a.coeffs[i]) mod P


func `*`[P,DEG,MOD](a,b:GenFiniteField[P,DEG,MOD]):GenFiniteField[P,DEG,MOD] =
    discard #TODO
func `*=`[DEG,MOD](a:var GenFiniteField[DEG,MOD],b:GenFiniteField[DEG,MOD]) {.inline.} =
    a = a * b

func `^`[P,DEG,MOD](a:GenFiniteField[P,DEG,MOD],exp:int):GenFiniteField[P,DEG,MOD] =
    binaryExponentiation(a, exp)
